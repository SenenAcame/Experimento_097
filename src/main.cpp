...
int main()
{
    ...
    // -------------------------
    Shader shader("assets/shaders/shader_blend.vs", "assets/shaders/shader_blend.fs");
    Shader screenShader("assets/shaders/shader_fb_screen.vs", "assets/shaders/shader_fb_screen.fs");
    ...
    // load textures
    // -------------
    unsigned int cubeTexture  = loadTexture("assets/shaders/container.jpg");
    unsigned int floorTexture = loadTexture("assets/shaders/metal.png");
